    ...
    fn: (argv, context) => {
        ...
        searchWiki.then(function(body) {
            ...
            if (searchResults[1].length > 0) {
                ...
                var parseUrl = 'http://acpedia.org/api.php?action=parse&page=' + searchResults[1][0] + '&prop=images|externallinks|sections|revid|displaytitle&format=json&redirects=true&callback=?';
